...
const dietista: Specialist = { name: "Elisa Pedrolini", role: "Dietista", href: "/altri-professionisti#elisa-pedrolini" };
...
export const serviceAreas: ServiceArea[] = [
  ...
  { slug: "nutrizione-dieta", number: "08", title: "Nutrizione e dieta", shortTitle: "Nutrizione e dieta", lead: "Un supporto nutrizionale personalizzato, integrato agli obiettivi di salute e benessere.", services: [
    { slug: "visita-dietistica", title: "Visita dietistica e valutazione nutrizionale", summary: "Anamnesi clinica, alimentare e dello stile di vita per comprendere bisogni e obiettivi della persona.", specialists: [dietista] },
    { slug: "educazione-alimentare", title: "Educazione alimentare", summary: "Strumenti concreti per costruire un’alimentazione equilibrata, varia e sostenibile nel tempo.", specialists: [dietista], images: [{ src: "/images/services-generated/educazione-alimentare-1.webp", alt: "Dietista insegna a comporre un piatto equilibrato" }, { src: "/images/services-generated/educazione-alimentare-2.webp", alt: "Confronto pratico delle porzioni alimentari" }] },
    { slug: "composizione-corporea", title: "Analisi della composizione corporea", summary: "Circonferenze, bioimpedenziometria e plicometria, quando indicate, per andare oltre il numero sulla bilancia.", specialists: [dietista] },
    { slug: "percorso-nutrizionale", title: "Ricomposizione corporea e gestione del peso", summary: "Piano alimentare personalizzato e controlli periodici per perdita, aumento o ricomposizione del peso corporeo.", specialists: [dietista] },
    { slug: "nutrizione-condizioni-fisiologiche", title: "Nutrizione nelle diverse fasi della vita", summary: "Supporto personalizzato in gravidanza, menopausa e nei percorsi di prevenzione.", specialists: [dietista] },
    { slug: "nutrizione-patologie", title: "Nutrizione e condizioni patologiche", summary: "Gestione nutrizionale integrata di patologie diagnosticate, in confronto con il medico curante.", specialists: [dietista], images: [{ src: "/images/services-generated/nutrizione-patologie-1.webp", alt: "Colloquio di nutrizione clinica per una condizione diagnosticata" }, { src: "/images/services-generated/nutrizione-patologie-2.webp", alt: "Adattamento di un piano nutrizionale clinico" }] },
    { slug: "nutrizione-gastrointestinale", title: "Nutrizione e disturbi gastrointestinali", summary: "Percorsi per reflusso, intestino irritabile, stipsi e gastrite già diagnosticati.", specialists: [dietista] },
    { slug: "nutrizione-sportiva", title: "Nutrizione sportiva", summary: "Alimentazione, composizione corporea ed eventuale integrazione coerenti con allenamenti e obiettivi dell’atleta.", specialists: [dietista] },
  ]},
];
