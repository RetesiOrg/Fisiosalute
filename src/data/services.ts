...
const physios: Specialist[] = [
  ...
  { name: "Alessandra Cao", role: "Fisioterapista e massoterapista MCB", href: "/staff#alessandra-cao" },
];
...
export const serviceAreas: ServiceArea[] = [
  ...
  { slug: "medicina-specialistica", number: "02", title: "Medicina specialistica", shortTitle: "Area medica", lead: "Competenze mediche integrate con il percorso fisioterapico e riabilitativo.", services: [
    { slug: "fisiatria", title: "Fisiatria", summary: "Valutazione medica delle problematiche che limitano movimento, funzione e qualità di vita.", paragraphs: ["Il fisiatra inquadra la problematica dal punto di vista clinico e funzionale, definisce gli obiettivi riabilitativi e coordina, quando necessario, il percorso con fisioterapisti e altri specialisti."], sections: [{ title: "La visita può essere utile per", items: ["Mal di schiena e dolore cervicale", "Problematiche muscolari, articolari e neurologiche", "Dolore acuto o cronico", "Infortuni e traumi", "Recupero pre e post chirurgico"] }] },
    { slug: "ortopedia", title: "Ortopedia e traumatologia", summary: "Diagnosi e trattamento delle problematiche di ossa, articolazioni, muscoli, tendini e legamenti.", paragraphs: ["La valutazione ortopedica aiuta a inquadrare traumi e problemi strutturali, approfondire un dolore persistente e stabilire il trattamento conservativo o chirurgico più appropriato."], sections: [{ title: "Ambiti principali", items: ["Traumi, fratture, distorsioni e instabilità", "Artrosi e problematiche degenerative", "Lesioni muscolari, tendinee e legamentose", "Problematiche della colonna", "Percorsi pre e post operatori"] }] },
    { slug: "terapie-infiltrative", title: "Terapie infiltrative", summary: "Trattamenti eseguiti dal medico specialista dopo un’accurata valutazione ortopedica.", paragraphs: ["Quando indicate, le infiltrazioni possono aiutare a gestire dolore e infiammazione e creare condizioni più favorevoli per il percorso riabilitativo."], sections: [{ title: "Tipologie", items: ["Farmaci antidolorifici", "Farmaci antinfiammatori", "Acido ialuronico intra-articolare"] }] },
    { slug: "otorinolaringoiatria", title: "Otorinolaringoiatria", summary: "Valutazione specialistica di orecchio, naso, gola, equilibrio, voce e deglutizione.", paragraphs: ["La visita ORL permette di comprendere l’origine dei sintomi e individuare il percorso più appropriato, anche in collaborazione con la riabilitazione vestibolare."], sections: [{ title: "Quando rivolgersi allo specialista", items: ["Disturbi dell’udito e acufeni", "Vertigini e instabilità", "Otiti, riniti e sinusiti", "Difficoltà respiratorie", "Disturbi della voce o della deglutizione"] }] },
  ]},
  { slug: "pilates-postura", number: "03", title: "Pilates clinico e rieducazione posturale", shortTitle: "Pilates e postura", lead: "Movimento guidato per migliorare controllo, forza, mobilità e consapevolezza.", services: [
  ...
  { slug: "terapie-fisiche", number: "04", title: "Terapie fisiche", shortTitle: "Terapie fisiche", lead: "Tecnologie utilizzate quando appropriate, all’interno di un progetto terapeutico personalizzato.", services: [
    { slug: "laserterapia", title: "Laserterapia", summary: "Terapia fisica strumentale inserita, quando indicata, nel percorso di recupero." },
    { slug: "tecarterapia", title: "Tecarterapia", summary: "Trattamento strumentale di supporto, definito sulla base della valutazione clinica." },
  ]},
  { slug: "salute-benessere-donna", number: "05", title: "Salute e benessere donna", shortTitle: "Donna", lead: "Percorsi dedicati alle diverse fasi della vita e al benessere femminile.", services: [
  ...
  { slug: "dieta-nutrizione", number: "06", title: "Dieta e nutrizione", shortTitle: "Nutrizione", lead: "Un supporto nutrizionale personalizzato, integrato agli obiettivi di salute e benessere.", services: [
